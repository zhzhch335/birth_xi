    ...
    <div v-if="showContent" @click="showContent = null" class="blackCover" style="z-index:7">
      <div class="postcard">
        ...
        <div @click.stop="()=>{}" v-if="showContent == 'thanks'" class="thanks">
          ...
          <div class="name">
            凉城暮暖（页面设计及标题制作）、月上弦下月上弦（创意）、不忘那抹天蓝（创意）、么鱼（祝福收集）
          </div>
          <div class="staff">
            制作协力
          </div>
          <div class="name">
            烧煤型驱逐舰、镜下茗、-SiroccO-、t541h、头快裂开了、窝窝头想要变得好吃、月华锦袖、中国梦点亮星辰大海、克比斯特、希桃二创小作坊
          </div>
          <div class="staff">
            画师 or 表情包工匠
          </div>
          ...
          <div class="name">
            时光荏苒、烧煤型驱逐舰、太阳系系王、么鱼、月上弦下月上弦、凉城暮暖、诸葛谭所、骑士贝狄威尔
          </div>
        </div>
